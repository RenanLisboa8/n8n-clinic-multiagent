...
if [ $FAILED -gt 0 ]; then
    ...
    echo "2. Configure credentials (see QUICK_START.md)"
    echo "3. Replace {{PLACEHOLDER}} tokens (see workflows/README.md)"
    echo "4. Activate main workflows:"
    echo "   - 01 - WhatsApp Main Handler"
    echo "   - 02 - Telegram Internal Assistant"
    echo "   - 03 - Appointment Confirmation Scheduler"
